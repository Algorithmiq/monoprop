...
def record_model_stats(bench_comm: Any) -> Callable[..., None]:
    ...
    def _do(model: str, propagator: Any, baseline_rss: int) -> None:
        ...
        # Called here and not from the fixture body: the propagator is alive at this point, and
        # its partition threads are what the probe counts.
        _record_placement(bench_comm)
