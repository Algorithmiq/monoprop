# A/B summary: ab-hashfree-nodes-1874210
...
arm_2_md5	a155dc8c6e31f6e4075969caefbf6b0e
arm_2_rev	e3462b97
arm_2_env	
...
| --- | ---: | ---: | ---: | ---: | ---: |
| time test_model_propagate[hubbard] | 186.166 s | 185.848 s | 1.000 | 3/5 | 1.000 |
| peak RSS (ranks summed) | 48.706 GiB | 47.860 GiB | 0.983 | 5/5 | 0.062 |
...
| peak bytes/term (ranks summed) | 52.21 B/term | 51.30 B/term | 0.983 | 5/5 | 0.062 |
...
| metric | ref median | wire median | wire/ref (paired median) | agree | p |
| --- | ---: | ---: | ---: | ---: | ---: |
| time test_model_propagate[pauli] | 117.320 s | 118.758 s | 1.012 | 5/5 | 0.062 |
| peak RSS (ranks summed) | 73.787 GiB | 69.750 GiB | 0.945 | 5/5 | 0.062 |
...
| peak bytes/term (ranks summed) | 80.36 B/term | 75.96 B/term | 0.945 | 5/5 | 0.062 |

## Compact summary

| row | arm | time ratio | RSS ratio (summed) | bytes/term ratio |
| --- | --- | ---: | ---: | ---: |
| B_8x16 hubbard fresh | wire | 1.000 | 0.983 | 1.000 |
| B_8x16 pauli fresh | wire | 1.012 | 0.945 | 1.000 |
