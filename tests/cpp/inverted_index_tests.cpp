...
// Above the serial floor (kFillSerialMin = 16384) rebuild takes the row-block-parallel fill when TBB
// has >1 worker. Its contract is that sparse row-lists come out ASCENDING regardless of thread
