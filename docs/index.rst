...
The simulator backend represents quantum operators and states in the Majorana basis. Two front-ends build on it: ``MajoranaPropagator`` for native Majorana and fermionic problems, and ``QubitPropagator`` for qubit (Pauli) problems, which it takes directly and truncates by Pauli weight.
