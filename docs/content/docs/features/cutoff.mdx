...
[Propagation Algorithm](/docs/concepts/algorithm)). The strategies differ only in how they measure the
...
[Notation](/docs/concepts/notation) for the theory. The basis change is a list of $2N$
