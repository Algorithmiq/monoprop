...
sim.upper_atol = 1e-3
```
Note that choosing very low value for `upper_atol` results in increase size of the
kept Majorana monomials, which eventually may even grow exponential in the number of gates.
