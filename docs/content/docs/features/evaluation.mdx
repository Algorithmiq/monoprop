...
The terms are given as [Majorana][] terms (or raw index tuples) for [MajoranaPropagator][] or [Pauli][] terms for
[PauliPropagator][]. The returned NumPy array contains the corresponding coefficients, preserving the order.
