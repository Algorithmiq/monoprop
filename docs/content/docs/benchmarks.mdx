...
| --- | --- | --- |
`DCGP (CPU) | 2× Intel Xeon Platinum 8480+, 112 cores, ~480 GB RAM | `monoprop` (56 threads), `PauliPropagation.jl` (28), `QuEra ppvm`, `Qiskit pauli-prop` |
| Booster (GPU) | NVIDIA A100-SXM-64GB, 8 host cores | `cuPauliProp` |
