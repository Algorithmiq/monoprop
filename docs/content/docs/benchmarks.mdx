...
![Benchmark results for Pauli Propagation engines: Runtime per Trotter step](/benchmarks/runtime.png)

![Benchmark results for Pauli Propagation engines: Memory per Trotter step](/benchmarks/memory.png)
