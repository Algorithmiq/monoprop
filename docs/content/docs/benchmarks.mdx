...
All simulation parameters live in [`settings.json`](https://github.com/Algorithmiq/monoprop/blob/main/benches/third_party/pauli_prop/settings.json) and are shared by every engine
