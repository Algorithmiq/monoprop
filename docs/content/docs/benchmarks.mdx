...
![Runtime per Trotter step](/benchmarks/runtime.png)

![Memory per Trotter step](/benchmarks/memory.png)
...
This reads the json file results for each simulation and produces four linear scale plots.
...
![Number of terms vs layers](/benchmarks/majorana/num_terms_vs_layers.png)

![Final overlap vs layers](/benchmarks/majorana/overlap_vs_layers.png)

![Runtime vs layers](/benchmarks/majorana/runtime_vs_layers.png)

![Memory vs layers](/benchmarks/majorana/memory_vs_layers.png)
