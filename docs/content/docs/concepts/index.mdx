...
- [Notation](/docs/concepts/notation) — the Majorana basis, monomials and their Hermitian
...
- [Interface](/docs/concepts/interface) — how a problem is expressed: the fermionic, qubit,
  and Majorana operator formats, the reference state, and how a circuit is
  described for simulation.
- [Propagation Algorithm](/docs/concepts/algorithm) — how propagation works: applying a gate, combining
  monomials, controlling term growth through truncation, and evaluating
  expectation values and gradients.
- [Simulation modes](/docs/concepts/simulation_modes) — the Heisenberg and Schrödinger pictures:
