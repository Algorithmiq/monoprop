...
- [Expectation values and gradients](/features/evaluation) — which circuit a graph grown over
  several `build_graph` calls adds up to, and how its axis is numbered, also follow the picture.
