...
.. doctest::
   ...
   >>> # One Majorana rotation exp(-i θ/2 · M_γ) generated by M_γ = i m_4 m_5. A gate
   >>> # is a pure generator bundling the monomials it generates as Terms; the i
   >>> # prefactor folds into gen_coeff. A MajoranaCircuit pairs the gate with its angle.
   >>> gate = MajoranaGate((Term((4, 5), -1.0),))
...
.. doctest::
   ...
   >>> gate = PauliGate((0,), PauliOperator(["X"], [1.0]))  # exp(-i θ/2 · X_0)
