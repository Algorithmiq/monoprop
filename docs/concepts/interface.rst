...
.. testcode::
   ...
   from monoprop.fermi_data import FermiOperator, FermiEvGate, FermiGatesSequence
   ...
   circuit = FermiGatesSequence(gates=[FermiEvGate(generator, 0.3)])
...
.. testcode::
   ...
   from monoprop.pauli_data import PauliOperator, PauliEvGate, PauliGatesSequence
   ...
   circuit = PauliGatesSequence(gates=[gate], num_qubits=2)
...
.. testcode::
   ...
   from monoprop import MonomialPropagator
   from monoprop.fermi_data import MajoranaOperator, FermiEvGate, FermiGatesSequence
