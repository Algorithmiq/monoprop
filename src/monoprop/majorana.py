...
class Majorana:
    r"""A single Majorana monomial: the ordered product :math:`m_{i_1} \cdots m_{i_w}`.
    ...
    repeated index is rejected because :math:`m_i^2 = 1` would silently change the monomial's
