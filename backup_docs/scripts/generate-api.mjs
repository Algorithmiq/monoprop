...
// Public modules, in the order they should appear in the sidebar, with the
// human-readable titles from the old python-api.rst section headings.
const MODULES = [
  ['monomial_propagator', 'Simulator'],
...
async function main() {
  ...
  for (const file of files) {
    ...
    // Give each module index page its friendly title.
