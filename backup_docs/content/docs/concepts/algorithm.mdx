...
definitions in [Notation](/docs/concepts/notation), and the method is described in full in
[@Miller2025-aj].
...
branch); recall from [Notation](/docs/concepts/notation) that the product of two
...
$m_{2j-1}m_{2j}$ on a mode (see [Notation](/docs/concepts/notation)) - is always kept, no
...
The same idea applies in the Pauli picture (see [Notation](/docs/concepts/notation)).
...
[Notation](/docs/concepts/notation)), the algorithm never sums over the exponentially many
...
- [Notation](/docs/concepts/notation) - the Majorana basis, monomials, commutation rule, and pairing structure this page relies on.
- [Interface](/docs/concepts/interface) - how to express operators and circuits as input.
- [Python API](/docs/api) - the full API reference for driving a simulation.
