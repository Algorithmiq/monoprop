...
[Propagation Algorithm](/docs/concepts/algorithm) page builds directly on these definitions.
...
choice of how to read the data, and the [propagation algorithm](/docs/concepts/algorithm) is
unchanged.

### Support cutoff = Pauli weight

The encoding is consulted only when truncation is applied (see [truncation](/docs/concepts/algorithm#truncation-controlling-growth)).
