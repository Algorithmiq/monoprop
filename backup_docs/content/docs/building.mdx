...
See [Parallelism and distribution](/docs/features/parallelism) for the communicator options and the
...
- [Getting Started](/docs/getting-started) — installing a prebuilt release from PyPI.
- [Parallelism and distribution](/docs/features/parallelism) — running across MPI ranks and shared-memory threads.
- [How to Contribute](/docs/how-to-contribute) — the full test and documentation workflow.
