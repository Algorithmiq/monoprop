...
// reuses `graph`'s layer cores (shared_ptr — no cross-rank copy) and stores a pruned CosineWordList
...
// cross-rank replays unmasked, exactly as today. Definitions live in src/pare/PareGraph.cpp.
