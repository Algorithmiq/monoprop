...
struct MPOperatorMemoryBreakdown final {
    ...
    // never double-count.
    size_t inverted_index_dense_bytes{0uz};  // of inverted_index_bytes: chunk-height bitmap payloads
    size_t inverted_index_sparse_bytes{0uz}; // of inverted_index_bytes: posting-container payloads
    size_t inverted_index_bitmap_chunks{0uz};
    size_t inverted_index_delta_bytes{0uz}; // of inverted_index_sparse_bytes: the byte-delta payloads
    size_t inverted_index_dir_bytes{0uz};   // the chunk directory: this layout's fixed per-chunk overhead
    size_t inverted_index_tail_bytes{0uz};  // of inverted_index_sparse_bytes: the unsealed growing chunk
    size_t inverted_index_arena_slack_bytes{0uz};
