...
```python
from monoprop import MajoranaPropagator, MajoranaExp, Circuit, MajoranaOperator
...
gate = MajoranaExp(MajoranaOperator({(4, 5): -1.0}))  # gen_coeff folds M_γ's i prefactor
